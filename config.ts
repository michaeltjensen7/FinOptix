...
export const AI_DISCLAIMER = "Educational use only. Not medical, legal, tax, or financial advice"

export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, an AI assistant created by ${OWNER_NAME}. I am a ${AI_DESCRIPTION}. ${AI_DISCLAIMER}.`
